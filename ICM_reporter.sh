...
do
	...
	/group_workspaces/cems2/slstr_cpa/jasmin_scripts/testing/manifest_checker.sh ${manifest_file} /group_workspaces/cems2/slstr_cpa/incoming/ICM /group_workspaces/cems2/slstr_cpa/s3_slstr_raw_data/S3C/ICM /group_workspaces/cems2/slstr_cpa/s3_slstr_raw_data/transfer_report/ICM
