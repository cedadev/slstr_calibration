...
then
	...
	/group_workspaces/cems2/slstr_cpa/software/slstr_calibration/create_tar.sh $manifest_file /group_workspaces/cems2/slstr_cpa/s3_slstr_raw_data/backup/S3C/ICM/
